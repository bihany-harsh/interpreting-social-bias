...
random_neg_adjs = json.load(open('../metadata/100_random_neg_adjs.json', 'r'))
neg_cer_adjs = json.load(open('../metadata/100_random_worse_adjs.json', 'r'))
neg_cest_adjs = json.load(open('../metadata/100_random_worst_adjs.json', 'r'))
random_pos_adjs = json.load(open('../metadata/100_random_pos_adjs.json', 'r'))
pos_cer_adjs = json.load(open('../metadata/100_random_better_adjs.json', 'r'))
pos_cest_adjs = json.load(open('../metadata/100_random_best_adjs.json', 'r'))
